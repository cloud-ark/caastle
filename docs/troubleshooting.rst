...
- Check deployment related files that are generated by CloudARK
   
   - CloudARK stores generated files in individual directories inside the '~/.cld/data/deployments' folder


- Check if all the CloudARK's cloud extensions have loaded correctly
...
-  Install and start CloudARK in fresh virtual environment manually:
